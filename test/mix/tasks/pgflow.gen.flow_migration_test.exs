defmodule Mix.Tasks.Pgflow.Gen.FlowMigrationTest do
  use ExUnit.Case, async: false

  alias Mix.Tasks.Pgflow.Gen.FlowMigration, as: GenFlow
  ...
  describe "generated migration content" do
    test "includes proper module documentation" do
      ...
      assert migration_content =~ "Generated by: mix pgflow.gen.flow_migration"
    end
